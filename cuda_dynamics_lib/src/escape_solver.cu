...
// Explicit template instantiation for the Standard Map
#include "../../maps/standard_map.h"
template void calculate_escape_time<2, StandardMap, StandardMapParams>(
    const StandardMap&, const StandardMapParams&, const double*, long long, int, double*, double*);