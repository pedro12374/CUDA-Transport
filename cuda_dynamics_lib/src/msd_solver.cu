#include "cuda_dynamics.h" // Include our library's header
...
template void calculate_msd_and_displacement<2, StandardMap, StandardMapParams>
    (const StandardMap&, const StandardMapParams&, const double*, const double*, const double*, long long, int, double*, double*, double*);
